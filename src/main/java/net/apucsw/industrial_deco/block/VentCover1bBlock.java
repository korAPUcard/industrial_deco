...
public class VentCover1bBlock extends IndustrialDecoModElements.ModElement {
	@ObjectHolder("industrial_deco:vent_cover_1b")
	public static final Block block = null;

	public VentCover1bBlock(IndustrialDecoModElements instance) {
		super(instance, 20);
	}
