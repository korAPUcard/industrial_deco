...
public class VentCover1aBlock extends IndustrialDecoModElements.ModElement {
	@ObjectHolder("industrial_deco:vent_cover_1a")
	public static final Block block = null;

	public VentCover1aBlock(IndustrialDecoModElements instance) {
		super(instance, 19);
	}
