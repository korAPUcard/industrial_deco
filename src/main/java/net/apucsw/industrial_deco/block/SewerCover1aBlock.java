...
public class SewerCover1aBlock extends IndustrialDecoModElements.ModElement {
	@ObjectHolder("industrial_deco:sewer_cover_1a")
	public static final Block block = null;

	public SewerCover1aBlock(IndustrialDecoModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("sewer_cover_1a");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction.Axis) state.get(AXIS)) {
				case X :
					return VoxelShapes.or(makeCuboidShape(15, 0, 0, 16, 16, 16)
				...
				default :
					return VoxelShapes.or(makeCuboidShape(0, 15, 0, 16, 16, 16)
							...
							.withOffset(offset.x, offset.y, offset.z);
				case Z :
					return VoxelShapes.or(makeCuboidShape(0, 0, 1, 16, 16, 0)
