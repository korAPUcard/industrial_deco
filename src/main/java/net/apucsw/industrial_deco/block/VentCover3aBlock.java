...
public class VentCover3aBlock extends IndustrialDecoModElements.ModElement {
	@ObjectHolder("industrial_deco:vent_cover_3a")
	public static final Block block = null;

	public VentCover3aBlock(IndustrialDecoModElements instance) {
		super(instance, 31);
	}
