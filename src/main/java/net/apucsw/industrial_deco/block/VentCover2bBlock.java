...
public class VentCover2bBlock extends IndustrialDecoModElements.ModElement {
	@ObjectHolder("industrial_deco:vent_cover_2b")
	public static final Block block = null;

	public VentCover2bBlock(IndustrialDecoModElements instance) {
		super(instance, 22);
	}
