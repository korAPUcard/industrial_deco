...
public class SewerCover1bBlock extends IndustrialDecoModElements.ModElement {
	@ObjectHolder("industrial_deco:sewer_cover_1b")
	public static final Block block = null;

	public SewerCover1bBlock(IndustrialDecoModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("sewer_cover_1b");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction.Axis) state.get(AXIS)) {
				case X :
					return VoxelShapes.or(makeCuboidShape(7.5, 0, 0, 8.5, 16, 16)
				...
				default :
					return VoxelShapes.or(makeCuboidShape(0, 7.5, 0, 16, 8.5, 16)
							...
							.withOffset(offset.x, offset.y, offset.z);
				case Z :
					return VoxelShapes.or(makeCuboidShape(0, 0, 8.5, 16, 16, 7.5)
