...
public class VentCover2aBlock extends IndustrialDecoModElements.ModElement {
	@ObjectHolder("industrial_deco:vent_cover_2a")
	public static final Block block = null;

	public VentCover2aBlock(IndustrialDecoModElements instance) {
		super(instance, 21);
	}
